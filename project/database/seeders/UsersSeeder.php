    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            [
                ...
                'phone' => '0775676001',
                'password' => Hash::make('husam@123'),
                'role_id' => 4,
                'image' => 'img/users/driver1.jpg',
            ],
            [
                'name' => 'adam',
                ...
                'role_id' => 4,
                'image' => 'img/users/driver2.jpg',
            ],
            [
                'name' => 'yamen',
                'email' => 'yamen@gmail.com',
                'phone' => '0775674781',
                'password' => Hash::make('yamen@123'),
                'role_id' => 4,
                'image' => 'img/users/driver3.jpg',
            ],
            [
                'name' => 'ayham',
