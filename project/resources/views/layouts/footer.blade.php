                  ...
                  <div class="pet-ccompany-slider" style="display: flex">
                    <div>
                      <div class="pet_company_column">
                          <figure >
                            <img style="height: 100px;width:178px" src="{{asset('img/brands/brand9.jpg')}}" alt="">
                          </figure>
                      </div>
                    </div>
                    <div>
                      <div class="pet_company_column">
                          <figure>
                            <img style="height: 100px;width:178px" src="{{asset('img/brands/brand2.png')}}" alt="">
                          </figure>
                      </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px;width:178px" src="{{asset('img/brands/brand3.jpg')}}" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px;width:178px" src="{{asset('img/brands/brand8.jpg')}}" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px;width:178px" src="{{asset('img/brands/brand5.jpg')}}" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px;width:178px" src="{{asset('img/brands/brand6.png')}}" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px;width:178px" src="{{asset('img/brands/brand7.png')}}" alt="">
                        </figure>
                    </div>
                  </div>
                </div>
          ...
          <div class="main_widget_row">
            <div class="widget_contact">
              ...
              <div class="main_widget_column">
                <span><img src="{{asset('images/phone-fig.png')}}"></span>
              ...
              <div class="main_widget_column">
                <span><img src="{{asset('images/envelope-fig.png')}}"></span>
                <div class="main_widget_contact">
              ...
              <div class="main_widget_column">
                <span><img src="{{asset('images/map-fig.png')}}"></span>
                <div class="main_widget_contact">
            ...
            <div class="pet_widget_column">
              <figure><img style="height: 74px;width:222px" src="{{asset('images/top-logo1.png')}}"></figure>
